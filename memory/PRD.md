...
- 12 holdings: Property, Super, Shares, ETFs, Cash, Managed Funds, Crypto, Other
...
- 7 holdings: Trust Portfolio (3 items), Super (2), Property (1), Cash (1)
...
6 phases: Hero gauge, Plain English, Actions, Timeline, Advisor Guidance, No complexity

## Completed (as of 14 April 2026)
- [x] Client data isolation: PersonalDashboard + InvestmentsOverview switch data per selected client (P1/P2)
- [x] Personal mode rollback: full LHS nav and 5-tab dashboard restored
