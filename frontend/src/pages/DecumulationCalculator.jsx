...
import {
  ...
  Home, Car, CreditCard, Landmark, ArrowUpDown, CircleDollarSign, Save, Upload
} from 'lucide-react';
import {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/client-profile/retirement/save`, {
        ...
        body: JSON.stringify({
          ...
          structures: assets.map(a => ({
            structure: a.entity,
            structure_name: a.name,
            super_balance: a.asset_type.includes('super') ? a.current_value : 0,
            investment_balance: !a.asset_type.includes('property') && !a.asset_type.includes('super') ? a.current_value : 0,
            property_value: a.asset_type.includes('property') ? a.current_value : 0,
            liabilities: 0
          })),
                  ...
                  <Dialog open={showSaveDialog} onOpenChange={setShowSaveDialog}>
                    ...
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Save this decumulation calculation to a client profile and optionally push to connected platforms.
                        </DialogDescription>
                      </DialogHeader>
