...
import {
  ...
  // Retirement
  RetirementCalculator, DecumulationCalculator, RetirementPlanner, RetirementPlannerWorkbench, ContributionCalculator,
  ...
  BookIntelligence, MeetingAutomation, BatchExecution, ExecutionRails, BudgetReforms2027, BudgetExposureReport, DealsPipeline, VaultDocuments, WebhooksAdmin, RbacAdmin, AdviceMarketplace, OpenApiPlatform, FirmBranding, DeveloperSandbox, MeetingPrep, MeetingNotes,
...
const AppRouter = () => (
  <Routes>
    ...
    <Route path="/retirement-planner-workbench" element={<RetirementPlannerWorkbench />} />
    ...
    <Route path="/budget-reforms" element={<BudgetReforms2027 />} />
