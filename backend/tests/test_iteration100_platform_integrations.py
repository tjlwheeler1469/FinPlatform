...
class TestPlatformIntegrationsAvailable:
    ...
    def test_get_available_platforms(self):
        ...
        for platform in platforms:
            assert platform.get("bidirectional"), f"Platform {platform['platform_id']} should have bidirectional=True"
...
class TestPlatformConnect:
    ...
    def test_connect_amp_north_demo(self):
        ...
        assert data.get("bidirectional"), "Should have bidirectional=True"
...
class TestMultiStructureCalculation:
    ...
    def test_multi_structure_accumulation(self):
        ...
        assert data.get("is_multi_structure"), "Should be multi-structure calculation"
...
class TestRetirementDataSave:
    ...
    def test_save_retirement_data(self):
        ...
        assert data.get("profile_updated"), "Profile should be updated"
...
class TestHealthCheck:
    ...
    def test_health_check(self):
        ...
        assert adviceos.get("platform_integrations"), "platform_integrations should be enabled"
        assert adviceos.get("client_profile_retirement"), "client_profile_retirement should be enabled"
