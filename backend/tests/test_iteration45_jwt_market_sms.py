...
class TestJWTAuthentication:
    ...
    def test_verify_token_valid(self):
        ...
        data = response.json()
        assert data.get("valid"), "Token should be valid"
    ...
    def test_register_new_user(self):
        ...
        data = response.json()
        assert data.get("success"), "Registration should succeed"
...
class TestTwilioSMS:
    ...
    def test_send_verification_demo_mode(self):
        ...
        data = response.json()
        assert data.get("success"), "Should succeed in demo mode"
        assert data.get("demo_mode"), "Should be in demo mode"
    ...
    def test_verify_sms_code_demo_mode(self):
        ...
        data = response.json()
        assert data.get("success"), "Should succeed in demo mode"
        assert data.get("valid"), "Code should be valid in demo mode"
        assert data.get("demo_mode"), "Should be in demo mode"
    ...
    def test_verify_invalid_code_format(self):
        ...
        data = response.json()
        assert not not data.get("success") or data.get("valid"), "Invalid code format should fail"
    ...
    def test_validate_phone_number(self):
        ...
        data = response.json()
        assert data.get("valid"), "Valid phone should pass validation"
