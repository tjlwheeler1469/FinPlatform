...
class TestNotificationPreferences:
    ...
    def test_get_default_preferences(self, api_client):
        ...
        assert data["in_app_enabled"]
        assert data["desktop_push_enabled"]
    ...
    def test_save_preferences(self, api_client):
        ...
        assert not saved["desktop_push_enabled"]
        assert saved["quiet_hours_enabled"]
        assert not saved["categories"]["meeting"]
