    ...
    sample_clients = [
        {
            ...
            "phone": "0412 345 678",
            "mobile": "0412 345 678",
            "address": "28 Elm Street, Glen Waverley VIC 3150",
            "status": "active",
            "type": "household",
            ...
            "pending_tasks": 2,
            "pending_docs": 0,
            "recent_activity": "Annual review completed",
            "family_members": [
                {"name": "David Thompson", "relationship": "Primary", "dob": "1976-04-10", "age": 50},
                {"name": "Sarah Thompson", "relationship": "Spouse", "dob": "1978-08-22", "age": 48},
            ],
            "accounts": [
                {"id": 1, "name": "David - AustralianSuper", "type": "Superannuation", "institution": "AustralianSuper", "balance": 245000, "change": 12000, "change_percent": 5.1},
                {"id": 2, "name": "Sarah - REST Super", "type": "Superannuation", "institution": "REST Super", "balance": 198000, "change": 9500, "change_percent": 5.0},
                {"id": 3, "name": "Family Home - Glen Waverley", "type": "Property", "institution": "Direct", "balance": 985000, "change": 15000, "change_percent": 1.5},
                {"id": 4, "name": "Investment Unit - Brunswick", "type": "Property", "institution": "Direct", "balance": 620000, "change": 8000, "change_percent": 1.3},
                {"id": 5, "name": "Investment Portfolio", "type": "Investment", "institution": "Various", "balance": 126500, "change": 4200, "change_percent": 3.4},
                {"id": 6, "name": "Cash & TDs", "type": "Cash", "institution": "ING / Westpac", "balance": 63000, "change": 1500, "change_percent": 2.4},
            ],
            "goals": [
                {"id": 1, "name": "Retirement at 67", "target": 2500000, "current": 1608800, "progress": 64, "target_date": "2043-04-10"},
                {"id": 2, "name": "Pay off investment loan", "target": 380000, "current": 180000, "progress": 47, "target_date": "2035-01-01"},
                {"id": 3, "name": "Emergency fund $60K", "target": 60000, "current": 28000, "progress": 47, "target_date": "2027-12-31"},
            ],
            "insurance": [
                {"type": "Life", "provider": "TAL", "sum_insured": 800000, "premium": 1200, "status": "active"},
                {"type": "TPD", "provider": "TAL", "sum_insured": 500000, "premium": 800, "status": "active"},
                {"type": "Income Protection", "provider": "OnePath", "sum_insured": 10000, "premium": 1800, "status": "active"},
            ]
        },
        {
            "client_id": "client_2",
