...
ROUTE_REGISTRY = [
    ...
    ("routes.open_api", "router", "/api", "Open API platform — tokens + spec"),
    ("routes.branding", "router", "/api", "Firm branding / white-label"),
    ...
    ("routes.xplan_sync", "router", "/api", "Xplan 5-Module Sync Surface"),
